...
@LocalBinding(jndiBinding = "test/eid/applet/model/AuthenticationExpiredServiceBean")
public class AuthenticationExpiredServiceBean implements AuthenticationService {
