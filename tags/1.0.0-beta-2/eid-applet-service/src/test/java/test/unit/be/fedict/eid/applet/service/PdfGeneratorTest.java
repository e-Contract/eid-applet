...
public class PdfGeneratorTest {
	...
	private static final Log LOG = LogFactory.getLog(PdfGeneratorTest.class);

	private PdfGenerator testedInstance;

	@Before
	public void setUp() throws Exception {
		this.testedInstance = new PdfGenerator();
	}

	@Test
	public void nullEIdDataGivesEmptyPdf() throws Exception {
		byte[] document = this.testedInstance.generatePdf(null);
	...
	@Test
	public void identityPdf() throws Exception {
		// setup
	...
	@Test
	public void identityWithAddressPdf() throws Exception {
		// setup
		Identity identity = new Identity();
		identity.name = "Test Name";
		identity.firstName = "Test First name";
	...
	@Test
	public void identityWithAddressAndPhotoWithErrorsPdf() throws Exception {
		// setup
		Identity identity = new Identity();
		identity.name = "Test Name";
		identity.firstName = "Test First name";
