...
<title>OWASP eID Identification Result Page</title>
</head>
<body>
<h1>OWASP eID Identification Result Page</h1>
<p>This page shows the eID attributes acquired after an eID Identification operation.</p>
<table>
	<tr>
		<th>Attribute</th>
		<th>Value</th>
...
<a href="identification.jsp">Again</a>
|
<a href=".">Main Page</a>
</body>
</html>