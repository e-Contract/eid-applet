...
public class PersistenceTest {
	...
	public void sessionContextEntityAutogeneratedContextId() throws Exception {
		SessionContextEntity sessionContextEntity = new SessionContextEntity("http-session-id", "user-agent");
		...
		SessionContextEntity sessionContextEntity2 = new SessionContextEntity("http-session-id-2", "user-agent");
	...
	public void sessionContextEntityHttpSessionIdNullFails() throws Exception {
		SessionContextEntity sessionContextEntity = new SessionContextEntity(null, "user-agent");
	...
	public void sessionContextEntityUserAgentNullFails() throws Exception {
		SessionContextEntity sessionContextEntity = new SessionContextEntity("http-session-id", null);
	...
	public void testResults() throws Exception {
		...
		TestResultEntity testResultEntity = new TestResultEntity("test", "result", sessionContextEntity);
		this.entityManager.persist(testResultEntity);

		TestResultEntity testResultEntity2 = new TestResultEntity("test2", "result2", sessionContextEntity);
	...
	public void testTestReportQuery() throws Exception {
		// setup
		TestReportEntity testReportEntity = new TestReportEntity("javaVersion", "javaVendor", "osName", "osArch",
				"osVersion", "userAgent", "navigatorAppName", "navigatorAppVersion", "navigatorUserAgent");
